  ...
  return (
    <div className={"border-1 rounded-lg flex flex-row"}>
      <img
        ...
        className="w-[100px] h-[100px] md:w-[220px] md:h-[220px]"
      />
      <div className="flex flex-col items-center justify-center md:min-w-[220px] w-[100px] h-[100px] md:w-[220px] md:h-[220px] bg-gray-200 p-2 text-black">
